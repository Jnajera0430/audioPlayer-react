...
interface Props {
  ...
  handleOnClick: (e: MouseEvent<HTMLCanvasElement>) => void;
}

const AudioVisualizer: ForwardRefExoticComponent<Omit<Props, "ref"> & RefAttributes<HTMLCanvasElement>> = forwardRef(
  (
    {
      blob,
      width,
